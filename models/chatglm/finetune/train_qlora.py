...
def parse_args():
    ...
    parser.add_argument('--output_dir', type=str, default='output/test', help='checkpoint保存路径')
    parser.add_argument('--seed', type=int, default=42)
    parser.add_argument('--max_input_length', type=int, default=1024, help='instruction + input的最大长度')
    parser.add_argument('--max_output_length', type=int, default=1300, help='output的最大长度')
...
def train(global_args):
    ...
    trainer.model.save_pretrained(global_args.output_dir)
